...
const { $tippy, $BIMViewer, $Server, $LocaleService, $localeMessages } = useNuxtApp();
...
const server = ref<InstanceType<typeof $Server>>();
const bimViewer = ref<InstanceType<typeof $BIMViewer>>();
